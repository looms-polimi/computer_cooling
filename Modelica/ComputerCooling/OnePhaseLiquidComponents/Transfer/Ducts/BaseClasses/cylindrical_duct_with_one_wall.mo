...
extends IncompressibleLiquidComponents.BaseClasses.TwoPorts_pwh_OnePort_VHP(massStorage=true);
  ...
  replaceable model StreamSeparator = HeatTransfer.StreamSeparators.CylindricalWall_FiniteVolume
    constrainedby HeatTransfer.StreamSeparators.BaseClasses.Base_StreamSeparator;
    
  replaceable model liquidStream = LiquidStream_FiniteVolume_Cylindrical
    constrainedby BaseClasses.base_LiquidStream_FiniteVolume;
          
   StreamSeparator Wall (redeclare replaceable record materialRecord = materialRecord, L=L, t=t, n=n, l=l, TStart=TStart, D=D);
