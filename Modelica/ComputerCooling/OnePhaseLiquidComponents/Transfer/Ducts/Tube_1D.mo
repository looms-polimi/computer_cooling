...
model Tube_1D
  ...
  ComputerCooling.OnePhaseLiquidComponents.Transfer.Ducts.LiquidStream_FiniteVolume_GenericSection liquidStream(L = L, Ac=Modelica.Constants.pi*Dstream^2/4,per=Modelica.Constants.pi*Dstream, w_nom = w_nom, dp_nom = dp_nom, TStart = TStart, n = n, fluidHeats = fluidHeats, dz=dz,
