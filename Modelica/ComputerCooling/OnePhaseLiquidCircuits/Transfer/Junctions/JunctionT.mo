within ComputerCooling.OnePhaseLiquidCircuits.Transfer.Junctions;
...
model JunctionT
  ...
  ComputerCooling.OnePhaseLiquidCircuits.FlowControl.PressureDrops.DpLinear_NominalPoint dpLin_a(dp_nom = dp_nom_a, w_nom = w_nom_a) annotation(
    Placement(visible = true, transformation(origin = {0, 60}, extent = {{-20, -20}, {20, 20}}, rotation = -90)));
  ComputerCooling.OnePhaseLiquidCircuits.FlowControl.PressureDrops.DpLinear_NominalPoint dpLin_b(dp_nom = dp_nom_b, w_nom = w_nom_b) annotation(
    Placement(visible = true, transformation(origin = {-40, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  ComputerCooling.OnePhaseLiquidCircuits.FlowControl.PressureDrops.DpLinear_NominalPoint dpLin_c(dp_nom = dp_nom_c, w_nom = w_nom_c) annotation(
    Placement(visible = true, transformation(origin = {40, 0}, extent = {{20, -20}, {-20, 20}}, rotation = 0)));
