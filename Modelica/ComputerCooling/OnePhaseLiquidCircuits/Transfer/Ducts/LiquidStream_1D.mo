...
model LiquidStream_1D
  ...
  Interfaces.vHP surf(n=n) annotation(
    Placement(visible = true, transformation(origin = {10, 88}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, 80}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
