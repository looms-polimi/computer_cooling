...
model MoistAir "Moist air"
  ...
  input MassFraction x "vapour mass fraction [kg vap/kg tot]";
  //-----------------------------------------------------------------------------
  MassFraction X "absolute humidity [kg vap/kg da]";
  Pressure pv "vapour partial pressure";
  Pressure pvs "vapour saturation pressure";
  Real phi "relative humidity";
  Temperature Twb "wet bulb temperature";
  MassFraction Xs "absolute humidity [kg vap/kg da] at saturation (phi=1)";
