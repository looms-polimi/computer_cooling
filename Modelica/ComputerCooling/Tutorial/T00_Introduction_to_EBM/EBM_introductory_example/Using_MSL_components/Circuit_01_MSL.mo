...
equation
  connect(S.p, G.p) annotation(
    Line(points = {{-30, 0}, {-30, 20}, {-20, 20}}, color = {239, 41, 41}, thickness = 1.25));
  connect(G.n, C.p) annotation(
    Line(points = {{0, 20}, {10, 20}, {10, 0}}, color = {78, 154, 6}, thickness = 1.5));
  connect(S.n, gnd.p) annotation(
    Line(points = {{-30, -20}, {-30, -30}, {-10, -30}, {-10, -40}}, color = {0, 0, 255}, thickness = 1.5));
  connect(C.n, gnd.p) annotation(
    Line(points = {{10, -20}, {10, -30}, {-10, -30}, {-10, -40}}, color = {0, 0, 255}, thickness = 1.5));
