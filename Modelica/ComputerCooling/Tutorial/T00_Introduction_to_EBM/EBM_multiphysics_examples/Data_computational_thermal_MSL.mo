...
model Data_computational_thermal_MSL
  ...
  Read_trace utilisation()  annotation(
    Placement(visible = true, transformation(origin = {-166, 44}, extent = {{-14, -14}, {14, 14}}, rotation = 0)));
equation
  ...
  connect(V2.y, Cv2fu.u[1]) annotation(
    Line(points = {{-118, 10}, {-100, 10}}, color = {0, 0, 127}));
  connect(C.y, Cv2fu.u[2]) annotation(
  ...
  connect(utilisation.y, Cv2fu.u[3]) annotation(
    Line(points = {{-150, 44}, {-110, 44}, {-110, 10}, {-100, 10}}, color = {0, 0, 127}));
  annotation(
