...
model AE009_example_controlled_circuit_06
  ...
  ComputerCooling.Sensors.TemperatureSensor_liquid sTradin(unitCelsius = false) annotation(
    Placement(visible = true, transformation(origin = {-122, -28}, extent = {{-10, 10}, {10, -10}}, rotation = -90)));
...
equation
  ...
  connect(sTradin.out, PI_Tradin.PV) annotation(
    Line(points = {{-134, -28}, {-218, -28}, {-218, 2}, {-194, 2}}, color = {0, 0, 127}));
  connect(pump1.pwh_b, sTradin.pwh) annotation(
    Line(points = {{-118, 30}, {-122, 30}, {-122, -16}}));
protected
  annotation(
...
end AE009_example_controlled_circuit_06;