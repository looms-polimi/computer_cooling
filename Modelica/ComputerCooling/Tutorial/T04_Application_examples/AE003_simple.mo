...
model AE003_simple
  ...
  OnePhaseLiquidComponents.Transfer.Ducts.Tube_1D_uniform_w radiator(Dstream = 0.003, L = 10, dp_nom = 49999.99999999999, fluidHeats = true, n = 10, w_nom = 0.5 / 60)  annotation(
