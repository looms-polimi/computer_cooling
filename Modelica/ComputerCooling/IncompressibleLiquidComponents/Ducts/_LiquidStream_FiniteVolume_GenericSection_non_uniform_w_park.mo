...
model _LiquidStream_FiniteVolume_GenericSection_non_uniform_w_park
...
equation
  for i in 1:n loop
    ...
    Qport[i] = HT[i].gamma*All*(T[i]-Tst[i]);
  end for; 
...
end _LiquidStream_FiniteVolume_GenericSection_non_uniform_w_park;