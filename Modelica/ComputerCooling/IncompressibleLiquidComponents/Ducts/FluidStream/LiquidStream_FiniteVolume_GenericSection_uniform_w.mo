within ComputerCooling.IncompressibleLiquidComponents.Ducts.FluidStream;
...
equation
  w      =  kf*ComputerCooling.Functions.sqrtReg(dp);
  davg   =  sum(m.d)/n;
  v      =  w/davg/Ac;
  M      =  Vtot*davg;
...
end LiquidStream_FiniteVolume_GenericSection_uniform_w;