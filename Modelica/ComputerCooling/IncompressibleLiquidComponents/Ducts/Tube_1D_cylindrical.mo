...
model Tube_1D_cylindrical
  ...
  ComputerCooling.IncompressibleLiquidComponents.Ducts.LiquidStream_FiniteVolume_GenericSection liquidStream(L = L, Ac=Modelica.Constants.pi*Dstream^2/4,per=Modelica.Constants.pi*Dstream, w_nom = w_nom, dp_nom = dp_nom, TStart = TStart, n = n, fluidHeats = fluidHeats, gamma_corr=gammai_corr,dz=dz,
