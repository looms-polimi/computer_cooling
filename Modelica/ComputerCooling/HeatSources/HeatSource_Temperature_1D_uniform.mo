...
model HeatSource_Temperature_1D_uniform
...
protected
  final parameter ThermalResistance ri=R*n;
equation

  for i in 1:n loop
    hp.port[i].T-T_input = ri*hp.port[i].Q_flow;
  end for;
...
end HeatSource_Temperature_1D_uniform;