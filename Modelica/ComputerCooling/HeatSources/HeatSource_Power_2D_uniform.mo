...
equation
  ...
  for i in 1:rows loop
    for j in 1:cols loop
       hp.port[i,j].Q_flow = -P_input/rows/cols;
    end for;
  end for;
...
end HeatSource_Power_2D_uniform;