...
model test_coolingCircuit_powerInput
  ...
  IncompressibleLiquidComponents.Ducts.Tube_1D_GenericSection tube_hot(L = 0.1, dp_nom(displayUnit = "bar") = 100, n = 5) annotation(
  ...
  IncompressibleLiquidComponents.Ducts.Tube_1D_GenericSection tube_cold(dp_nom = 100, fluidHeats = true, n = 5) annotation(
    Placement(visible = true, transformation(origin = {60, 60}, extent = {{20, 20}, {-20, -20}}, rotation = 0)));
