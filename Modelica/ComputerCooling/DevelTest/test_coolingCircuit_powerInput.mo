...
model test_coolingCircuit_powerInput
  ...
  ComputerCooling.IncompressibleLiquidComponents.Ducts.Tube_1D_GenericSection tube_hot(L = 0.1, dp_nom(displayUnit = "bar") = 100, n = 5) annotation(
    Placement(visible = true, transformation(origin = {60, -56}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Modelica.Blocks.Sources.RealExpression power(y = 400) annotation(
    Placement(visible = true, transformation(origin = {-30, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ComputerCooling.IncompressibleLiquidComponents.Ducts.Tube_1D_GenericSection tube_cold(dp_nom = 100, fluidHeats = true, n = 5) annotation(
    Placement(visible = true, transformation(origin = {60, 56}, extent = {{20, 20}, {-20, -20}}, rotation = 0)));
