...
model test_pressuriser
  ...
  ComputerCooling.OnePhaseLiquidComponents.FlowControl.Pressurisers.PressuriserIdeal pressuriserIdeal(p = 499999.9999999999)  annotation(
  ...
  ComputerCooling.OnePhaseLiquidComponents.BoundaryConditions.BoundaryFixed_wT src(w = 1)  annotation(
    Placement(visible = true, transformation(origin = {-80, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
equation
