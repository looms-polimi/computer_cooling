...
model test_VentedTank
  OnePhaseLiquidComponents.Storage.VentedTank ventedTank(H = 1, V = 0.1, lstart = 0.5) annotation(
  ...
  OnePhaseLiquidComponents.BoundaryConditions.BoundaryFixed_pT snk(p(displayUnit = "Pa") = 0) annotation(
