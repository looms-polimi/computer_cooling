...
model test_liquidLoop
  ...
  ComputerCooling.OnePhaseLiquidComponents.Transfer.Ducts.Tube_1D tube_cold(L = 1, TStart (displayUnit = "K") = 300, W = 3.14 * 0.006 / 2, dp_nom(displayUnit = "bar") = 12500, fluidHeats = true, n = 5, t = 0.0005, w_nom = 0.002) annotation(
