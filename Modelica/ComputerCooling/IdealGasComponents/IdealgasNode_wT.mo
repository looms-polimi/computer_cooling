...
equation
  ...
  pwh_a.h =  cp*T;
annotation(
    Icon(graphics = {Text(origin = {-1, 0}, textColor = {255, 255, 255}, extent = {{-67, 46}, {67, -46}}, textString = "Vgas"), Rectangle(origin = {20, 0}, fillColor = {114, 159, 207}, fillPattern = FillPattern.Sphere, extent = {{-80, 80}, {80, -80}}), Text(origin = {22, 2}, textColor = {255, 255, 255}, extent = {{-84, 30}, {84, -30}}, textString = "wT")}));
end IdealgasNode_wT;
